...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex items-center rounded-lg bg-[#041424] border border-[#0d3558] p-1 gap-1',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'data-[state=active]:bg-[#0d3558] data-[state=active]:text-[--text-primary] data-[state=active]:shadow-sm',
